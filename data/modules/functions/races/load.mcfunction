...
#---------- Main: ------------------#
function libraries:scripts/location/init
scoreboard players set $module_races ins 1
tellraw @a {"text":"\u2588 [RPG] Engine: 'Races Module' Installed!","color":"blue","bold":"true"}

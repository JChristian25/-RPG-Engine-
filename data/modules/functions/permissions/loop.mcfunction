...
execute if score $module_permissions ins matches 1 run function modules:permissions/functions/operator/permission
execute if score $module_permissions ins matches 1 run function modules:permissions/functions/player/permission
